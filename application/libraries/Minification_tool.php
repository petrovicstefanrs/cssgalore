<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	* Taken from Tovic's GIST <https://gist.github.com/tovic/d7b310dea3b33e4732c0> 
	*/
	class Minification_tool
	{
		...
		function fn_minify_css($input, $comment = 2, $quote = 2) {
		    ...
		    $output = $prev = "";
		    foreach ($this->fn_minify([MINIFY_COMMENT_CSS, MINIFY_STRING], $input) as $part) {
		...
		//     return $this->fn_minify_css(...$lot);
		// }

		// function minify_html(...$lot) {
		//     return $this->fn_minify_html(...$lot);
		// }

		// function minify_js(...$lot) {
		//     return $this->fn_minify_js(...$lot);
		// }
	}
?>
