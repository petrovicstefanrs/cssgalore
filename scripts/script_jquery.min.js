$(document).ready(function() {
  ...
  function m() {
    ...
    if ("hex" == $("#box_shadow_color_type").val()) {
      ...
      var f;
      f = $("#box_shadow_color").val();
      f = (f = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(f)) ? {r:parseInt(f[1], 16), g:parseInt(f[2], 16), b:parseInt(f[3], 16)} : null;
      e = "rgba(" + f.r + "," + f.g + "," + f.b + "," + e + ")";
    }
    b || (b = 0);
    a || (a = 0);
    d || (d = 0);
  ...
  function p() {
    var b = $("#transform_scale_x").val(), a = $("#transform_scale_y").val(), d = $("#transform_translate_x").val(), c = $("#transform_translate_y").val(), h = $("#transform_skew_x").val(), e = $("#transform_skew_y").val(), f = $("#transform_rotate").val();
    b || (b = 1);
    a || (a = 1);
    d || (d = 0);
    c || (c = 0);
    ...
    e || (e = 0);
    f || (f = 0);
    var g = "scaleX(" + b + ") scaleY(" + a + ") rotate(" + f + "deg) translateX(" + d + "px) translateY(" + c + "px) skewX(" + h + "deg) skewY(" + e + "deg)";
    $(".transform_preview").css({"-moz-transform":g, "-webkit-transform":g, transform:g});
    !(b || a || d || c || h || e || f) || 1 == b && 1 == a && 0 == d && 0 == c && 0 == h && 0 == e && 0 == f ? $("#generated_code_text").html("There is no generated code") : (b && 1 != b || (g = g.replace(/scaleX\([a-zA-Z0-9\.]+\)/g, "")), a && 1 != a || (g = g.replace(/scaleY\([a-zA-Z0-9\.]+\)/g, "")), d && 0 != d || (g = g.replace(/translateX\([a-zA-Z0-9\.]+\)/g, "")), c && 0 != c || (g = g.replace(/translateY\([a-zA-Z0-9\.]+\)/g, "")), h && 0 != h || (g = g.replace(/skewX\([a-zA-Z0-9\.]+\)/g, 
    "")), e && 0 != e || (g = g.replace(/skewY\([a-zA-Z0-9\.]+\)/g, "")), f && 0 != f || (g = g.replace(/rotate\([a-zA-Z0-9\.]+\)/g, "")), $("#generated_code_text").html("<code><span>-moz-transform:" + g + ";</span></br><span>-webkit-transform:" + g + ";</span></br><span>transform:" + g + ";</span></code>"), $(".transform_preview").css({"-moz-transform":g, "-webkit-transform":g, transform:g}));
  }
  function k() {
    var b = $("#transition_opacity_timing").val(), a = $("#transition_opacity_opacity").val(), d = $("#transition_opacity_duration").val(), c = $("#transition_opacity_delay").val(), h = $("#transition_height_timing").val(), e = $("#transition_height_height").val(), f = $("#transition_height_duration").val(), g = $("#transition_height_delay").val(), k = $("#transition_width_timing").val(), l = $("#transition_width_width").val(), m = $("#transition_width_duration").val(), p = $("#transition_width_delay").val(), 
    ...
    t || (t = 0);
    r || (r = 0);
    e ? (f = "height " + f + "s " + h + " " + g + "s", h = "height: " + e + "px;") : h = f = "";
    l ? (m = "width " + m + "s " + k + " " + p + "s", k = "width: " + l + "px;") : k = m = "";
    a ? (d = "opacity " + d + "s " + b + " " + c + "s", b = "opacity: " + a + ";") : b = d = "";
    x ? (n = "background-color " + t + "s " + n + " " + r + "s", q = "background-color: " + q + ";") : q = n = "";
    n = (f + ", " + m + ", " + d + ", " + n).replace(/^([\,\s]+)|(\s\,\W)|([\,\s]+)$/g, " ");
    q = h + k + b + q;
    ...
    e || l || a || x ? $("#generated_code_text").html("<code>.selector{</br><span>-moz-transition:" + n + ";</span></br><span>-webkit-transition:" + n + ";</span></br><span>-o-transition:" + n + ";</span></br><span>transition:" + n + ";</span></br>}</code></br><code>.selector:hover{</br><span>" + q + "</span></br>}</code>") : $("#generated_code_text").html("There is no generated code");
  }
  function l() {
    var b = $("#gradient_start_color_linear").val(), a = $("#gradient_end_color_linear").val(), d = $("#gradient_angle").val(), c = $("#gradient_start_color_radial").val(), h = $("#gradient_start_size").val(), e = $("#gradient_end_color_radial").val(), f = $("#gradient_end_size").val();
  ...
  var z = new Clipboard(".copybtn");
  z.on("success", function(b) {
    Materialize.toast("Copied to clipboard", 4000);
  });
  z.on("error", function(b) {
