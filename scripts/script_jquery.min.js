$(document).ready(function() {
  ...
  function m() {
    var b = $("#box_shadow_horizontal_length").val(), a = $("#box_shadow_vertical_length").val(), d = $("#box_shadow_blur_radius").val(), c = $("#box_shadow_spread").val(), g = $("#box_shadow_position").val();
    "outset" == g && (g = "");
    ...
    if ("hex" == $("#box_shadow_color_type").val()) {
      ...
      var k = y($("#box_shadow_color").val()), e = "rgba(" + k.r + "," + k.g + "," + k.b + "," + e + ")";
    }
    b || (b = 0);
    a || (a = 0);
    d || (d = 0);
    c || (c = 0);
    !b && !a || 0 == b && 0 == a ? ($("#generated_code_text").html("There is no generated code"), $(".box_shadow_preview").css({"-moz-box-shadow":"none", "-webkit-box-shadow":"none", "box-shadow":"none"})) : ($("#generated_code_text").html("<code><span>-moz-box-shadow:" + g + " " + b + "px " + a + "px " + d + "px " + c + "px " + e + ";</span></br><span>-webkit-box-shadow:" + g + " " + b + "px " + a + "px " + d + "px " + c + "px " + e + ";</span></br><span>box-shadow:" + g + " " + b + "px " + a + 
    "px " + d + "px " + c + "px " + e + ";</span></code>"), $(".box_shadow_preview").css({"-moz-box-shadow":g + " " + b + "px " + a + "px " + d + "px " + c + "px " + e, "-webkit-box-shadow":g + " " + b + "px " + a + "px " + d + "px " + c + "px " + e, "box-shadow":g + " " + b + "px " + a + "px " + d + "px " + c + "px " + e}));
  }
  function p() {
    var b = $("#transform_scale_x").val(), a = $("#transform_scale_y").val(), d = $("#transform_translate_x").val(), c = $("#transform_translate_y").val(), g = $("#transform_skew_x").val(), e = $("#transform_skew_y").val(), k = $("#transform_rotate").val();
    b || (b = 1);
    a || (a = 1);
    d || (d = 0);
    c || (c = 0);
    ...
    e || (e = 0);
    k || (k = 0);
    var f = "scaleX(" + b + ") scaleY(" + a + ") rotate(" + k + "deg) translateX(" + d + "px) translateY(" + c + "px) skewX(" + g + "deg) skewY(" + e + "deg)";
    $(".transform_preview").css({"-moz-transform":f, "-webkit-transform":f, transform:f});
    !(b || a || d || c || g || e || k) || 1 == b && 1 == a && 0 == d && 0 == c && 0 == g && 0 == e && 0 == k ? $("#generated_code_text").html("There is no generated code") : (b && 1 != b || (f = f.replace(/scaleX\([a-zA-Z0-9\.]+\)/g, "")), a && 1 != a || (f = f.replace(/scaleY\([a-zA-Z0-9\.]+\)/g, "")), d && 0 != d || (f = f.replace(/translateX\([a-zA-Z0-9\.]+\)/g, "")), c && 0 != c || (f = f.replace(/translateY\([a-zA-Z0-9\.]+\)/g, "")), g && 0 != g || (f = f.replace(/skewX\([a-zA-Z0-9\.]+\)/g, 
    "")), e && 0 != e || (f = f.replace(/skewY\([a-zA-Z0-9\.]+\)/g, "")), k && 0 != k || (f = f.replace(/rotate\([a-zA-Z0-9\.]+\)/g, "")), $("#generated_code_text").html("<code><span>-moz-transform:" + f + ";</span></br><span>-webkit-transform:" + f + ";</span></br><span>transform:" + f + ";</span></code>"), $(".transform_preview").css({"-moz-transform":f, "-webkit-transform":f, transform:f}));
  }
  function h() {
    var b = $("#transition_opacity_timing").val(), a = $("#transition_opacity_opacity").val(), d = $("#transition_opacity_duration").val(), c = $("#transition_opacity_delay").val(), g = $("#transition_height_timing").val(), e = $("#transition_height_height").val(), k = $("#transition_height_duration").val(), f = $("#transition_height_delay").val(), h = $("#transition_width_timing").val(), l = $("#transition_width_width").val(), m = $("#transition_width_duration").val(), p = $("#transition_width_delay").val(), 
    ...
    t || (t = 0);
    r || (r = 0);
    e ? (k = "height " + k + "s " + g + " " + f + "s", g = "height: " + e + "px;") : g = k = "";
  ...
  function l() {
    var b = $("#gradient_start_color_linear").val(), a = $("#gradient_end_color_linear").val(), d = $("#gradient_angle").val(), c = $("#gradient_start_color_radial").val(), g = $("#gradient_start_size").val(), e = $("#gradient_end_color_radial").val(), h = $("#gradient_end_size").val();
